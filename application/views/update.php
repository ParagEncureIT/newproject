...
<style type="text/css">
	...
	.container .panel .panel-body .row .form-group{
		margin-top: 15px;
	}
...
<body>
	<form action="<?= base_url('welcome/update_action') ?>" method="post">
	<div class="container">
		<div class="panel">
			<div class="row">
				<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="hidden" name="id" value="<?php if(!empty($select)){ foreach ($select as $name) { echo $name->id;} } ?>">
							<div class="col-md-1">
							<span class="error" id="err_name"></span>&nbsp;</div>
							<div class="col-md-8">
								<input type="text" name="txtFullname" id="fullname" class="form-control input-md" placeholder="Full Name..." value="<?php if(!empty($select)){ foreach ($select as $name) { echo $name->full_name;} } ?>">
						...
						<div class="form-group">
							...
							<div class="col-md-1">
							<div class="error" id="err_email"></div></div>
							<div class="col-md-8">
								<input type="email" name="email" id="email" class="form-control input-md" placeholder="Email ID..." value="<?php if(!empty($select)){ foreach ($select as $name) { echo $name->email;} } ?>">

							</div><br><br>
						</div>
						<div class="form-group">
							<div class="col-md-3">Password</div><div class="col-md-1">
							<div class="error" id="err_pass"></div></div>
							<div class="col-md-8">
								<input type="password" name="password" id="password" class="form-control input-md" placeholder="Password..." value="<?php if(!empty($select)){ foreach ($select as $name) { echo $name->password;} } ?>">
						</div><br><br>
						</div>
						<div class="form-group">
							<div class="col-md-3">State</div><div class="col-md-1">
							<div class="error" id="err_state"></div></div>
							<div class="col-md-8">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								<button class="btn btn-primary input-md" onclick="return validate()">Update</button>
						</div>
						<div class="col-md-3">
